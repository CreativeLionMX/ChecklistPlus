import '../firma_check_onboarding/firma_check_onboarding_widget.dart';
...
class CheckListOnboarding4de4Widget extends StatefulWidget {
  const CheckListOnboarding4de4Widget({Key key}) : super(key: key);

  @override
  _CheckListOnboarding4de4WidgetState createState() =>
      _CheckListOnboarding4de4WidgetState();
}

class _CheckListOnboarding4de4WidgetState
    extends State<CheckListOnboarding4de4Widget> {
                    ...
                    InkWell(
                      onTap: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => FirmaCheckOnboardingWidget(),
                          ),
                        );
                      },
                      child: Icon(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Validación de Cursos y Calificaciones aprobatorias en UM',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText1
                                          .override(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Aplicación de Evaluación de Certificación ABC Inicial',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText1
                                          .override(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Envío de Comunicado de Felicitación WhatsApp y Certificado',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText1
                                          .override(
