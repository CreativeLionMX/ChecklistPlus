...
class FirmaCheckWidget extends StatefulWidget {
  const FirmaCheckWidget({Key key}) : super(key: key);

  @override
  _FirmaCheckWidgetState createState() => _FirmaCheckWidgetState();
}

class _FirmaCheckWidgetState extends State<FirmaCheckWidget> {
  DateTime datePicked;
