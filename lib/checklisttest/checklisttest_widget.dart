    ...
    return StreamBuilder<List<TareasRecord>>(
      stream: queryTareasRecord(
        queryBuilder: (tareasRecord) =>
            tareasRecord.orderBy('time_tarea', descending: true),
      ),
      builder: (context, snapshot) {
        ...
        List<TareasRecord> checklisttestTareasRecordList = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
                ...
                child: StreamBuilder<List<TareasRecord>>(
                  stream: queryTareasRecord(
                    queryBuilder: (tareasRecord) => tareasRecord
                        ...
                        .orderBy('titulo_tarea', descending: true),
                  ),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                    ...
                    List<TareasRecord> gridViewTareasRecordList = snapshot.data;
